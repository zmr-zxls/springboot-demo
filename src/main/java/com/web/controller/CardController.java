...
public class CardController {
  ...
  public ApiResult getCards(HttpSession session,
    ...
    return ApiResult.success(cardService.getCards(userid, PageRequest.of(pageIndex - 1, pageSize)));
  }
   ...
   */
  @GetMapping("/detail")
  public ApiResult detail(String id, @SessionAttribute("USERID") String userid) {
